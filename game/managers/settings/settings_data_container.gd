...
@onready var DEFAULT_SETTINGS: DefaultSettingsResource = load("res://game/managers/settings/resource/default_settings_resource.tres")
...
func create_storage_dictionary() -> Dictionary:
	var settings_container_dict = {
		...
		"MoveLeft": InputMap.action_get_events("MoveLeft"),
		"MoveRight": InputMap.action_get_events("MoveRight"),
		"MoveUp": InputMap.action_get_events("MoveUp"),
		"MoveDown": InputMap.action_get_events("MoveDown"),
